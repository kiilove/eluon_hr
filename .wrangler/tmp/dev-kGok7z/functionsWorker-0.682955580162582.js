...
// .wrangler/tmp/bundle-En0Igp/checked-fetch.js
...
// .wrangler/tmp/pages-mOXE3A/functionsWorker-0.682955580162582.mjs
...
var onRequestPost = /* @__PURE__ */ __name2(async (context) => {
  try {
    ...
    const format = /* @__PURE__ */ __name2((d) => `${d.getFullYear()}-${String(d.getMonth() + 1).padStart(2, "0")}-${String(d.getDate()).padStart(2, "0")}`, "format");
    const sStr = format(startDt);
    const eStr = format(endDt);
    try {
...
var TimeUtils = {
  ...
  // Get Week Key (WXX)
  getWeekKey: /* @__PURE__ */ __name2((dateInput) => {
...
var onRequestGet = /* @__PURE__ */ __name2(async (context) => {
  try {
    ...
    const { results: specialResults } = await env.DB.prepare(`
            ...
            ORDER BY l.work_date ASC
        `).bind(companyId, startDate, endDate).all();
    const transformLog = /* @__PURE__ */ __name2((r, type) => ({
      id: r.id,
      ...
      logStatus: r.log_status === "NORMAL" && r.status === "REST" ? "REST" : r.log_status,
      note: r.persona || "",
      isHoliday: false,
      // [Fix] Missing Fields
...
var onRequestGet3 = /* @__PURE__ */ __name2(async (context) => {
  try {
    ...
    const weeklyStats = /* @__PURE__ */ new Map();
    const add = /* @__PURE__ */ __name2((store, key, reg, spec) => {
    ...
    for (const log of workLogs || []) {
      ...
      const numberOfDays = Math.floor((d.getTime() - oneJan.getTime()) / (24 * 60 * 60 * 1e3));
...
var onRequestGet4 = /* @__PURE__ */ __name2(async (context) => {
  try {
    ...
    const getWeeksInMonth = /* @__PURE__ */ __name2((y, m) => {
      const weeks2 = [];
...
var uuid4Internal = /* @__PURE__ */ __name2(function() {
...
var uuid4 = /* @__PURE__ */ __name2(() => uuid4Internal(), "uuid4");
...
var isArrayInternal = /* @__PURE__ */ __name2((val) => (isArrayInternal = Array.isArray, isArrayInternal(val)), "isArrayInternal");
...
var sleep$1 = /* @__PURE__ */ __name2((ms) => new Promise((resolve) => setTimeout(resolve, ms)), "sleep$1");
var VERSION = "0.0.1";
...
function iterSSEChunks(iterator) {
  return __asyncGenerator(this, arguments, /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function* iterSSEChunks_1() {
    var _a2, e_5, _b, _c;
  ...
  }, "iterSSEChunks_1"), "iterSSEChunks_1"));
}
...
var onRequestPost12 = /* @__PURE__ */ __name2(async (context) => {
  try {
    ...
    allEmployees.forEach((e) => employeeMap.set(e.name, { id: e.id, companyId: e.company_id || "comp_eluon" }));
    ...
    const logsByEmp = /* @__PURE__ */ new Map();
    ...
    for (const [eid, dates] of logsByEmp.entries()) {
      ...
      for (let i = 0; i < dates.length; i += DATE_CHUNK) {
        ...
        deleteOps.push(
          env.DB.prepare(`DELETE FROM work_logs WHERE employee_id = ? AND work_date IN (${placeholders})`).bind(eid, ...chunk)
        );
      }
    }
    ...
    for (let i = 0; i < finalLogsToInsert.length; i += INSERT_CHUNK_SIZE) {
      ...
      const flattenedValues = chunk.flatMap((log) => {
        ...
        return [
          ...
          emp.companyId
          // [NEW] Insert Company ID (Confirmed from Map)
        ];
      });
      insertOps.push(
        env.DB.prepare(`
  ...
  try {
    ...
    if (existing) {
      await db.prepare(`
            ...
            `).bind(name, effective_date, base_multiplier || 1, special_work_multiplier || 1.5, night_work_multiplier || 0.5, targetId, companyId).run();
    } else {
      await db.prepare(`
                ...
                VALUES (?, ?, ?, ?, ?, ?, ?)
            `).bind(targetId, name, effective_date, base_multiplier || 1, special_work_multiplier || 1.5, night_work_multiplier || 0.5, companyId).run();
    }
...
var HolidayUtils = {
  ...
  LUNAR_HOLIDAYS: {
    ...
    "2025-01-30": "\uC124\uB0A0 \uC5F0\uD734",
    "2025-03-03": "\uB300\uCCB4\uACF5\uD734\uC77C",
    // 3.1절 is Sat? Not sure if auto-sub applies to all, assuming standard
    "2025-05-05": "\uC5B4\uB9B0\uC774\uB0A0",
    "2025-05-06": "\uBD80\uCC98\uB2D8\uC624\uC2E0\uB0A0",
    // Approx
    "2025-10-06": "\uCD94\uC11D",
   ...
   */
  init: /* @__PURE__ */ __name2(async (year) => {
    console.log(`[HolidayUtils] Init called for ${year} (Static Mode Active)`);
    return;
  }, "init"),
  getHolidayName: /* @__PURE__ */ __name2((date) => {
    const year = date.getFullYear();
  ...
  isHoliday: /* @__PURE__ */ __name2((date) => {
    return !!HolidayUtils.getHolidayName(date);
  }, "isHoliday")
};
var generateSafeTimeString = /* @__PURE__ */ __name2((minMinute, maxMinute, seed) => {
  let hash = 0;
...
var SpecialWorkAttendanceGenerator = class {
  ...
  static {
    __name2(this, "SpecialWorkAttendanceGenerator");
  }
  /**
  ...
  static validateAndCorrect(logs, targetMinutes, options) {
    const SLOT_CAP = 300;
    const getDuration = /* @__PURE__ */ __name2((log) => {
  ...
  static processCandidates(candidates, remainingMinutes, persona, timePref, options, logs, maxWeeklyOvertime) {
    ...
    for (const weekKey of weeks) {
      ...
      daysInWeek.sort((a, b) => {
        const typeRank = /* @__PURE__ */ __name2((type) => {
...
var SpecialWorkCalculator = {
   ...
   */
  toRecognizedHours: /* @__PURE__ */ __name2((minutes) => {
    if (!minutes) return 0;
   ...
   */
  calculateWage: /* @__PURE__ */ __name2((baseWage, multiplier) => {
   ...
   */
  calculateTotalPay: /* @__PURE__ */ __name2((recognizedHours, specialWage) => {
   ...
   */
  toOneDecimalHours: /* @__PURE__ */ __name2((minutes) => {
...
var onRequestPost15 = /* @__PURE__ */ __name2(async (context) => {
  try {
    ...
    if (save) {
      const monthKey = report.target_month;
...
\uC8FC\uCC28\uBCC4 \uC9C1\uC6D0 \uC218:
${metadata.weeklyStats ? metadata.weeklyStats.map((ws) => `- ${ws.week}: ${ws.employeeCount}\uBA85`).join("\n") : "\uC815\uBCF4 \uC5C6\uC74C"}
`;
    }
    const prompt = `
...
${contextInfo}
    ...
    1. **Key Risks Table**:
       ...
       - Add BOTH "\uC704\uBC18" and "\uC8FC\uC758" cases to the "\u{1F6A8} \uC8FC\uC694 \uC704\uBC18 \uC704\uD5D8 \uC0AC\uB840" table.
...
// .wrangler/tmp/bundle-En0Igp/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-En0Igp/middleware-loader.entry.ts
...
@google/genai/dist/web/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=functionsWorker-0.682955580162582.js.map
