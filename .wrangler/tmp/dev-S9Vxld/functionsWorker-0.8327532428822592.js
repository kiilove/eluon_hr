...
// .wrangler/tmp/bundle-CLQQsQ/checked-fetch.js
...
// .wrangler/tmp/pages-iu6yOd/functionsWorker-0.8327532428822592.mjs
      ...
      statements.push(
        env.DB.prepare(`
                INSERT OR REPLACE INTO work_logs (
                    ...
                    status, log_status, overtime_minutes, actual_work_minutes, created_at
                ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            `).bind(
          crypto.randomUUID(),
          // Note: REPLACE changes ID. Ideally we keep ID if updating? 
          // But for logs, replacing logic is acceptable or use ON CONFLICT UPDATE if we want stable ID.
          // Simplify: Just replace.
          employeeId,
          log.date,
          startTimeStr,
          endTimeStr,
...
// .wrangler/tmp/bundle-CLQQsQ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-CLQQsQ/middleware-loader.entry.ts
...
@google/genai/dist/web/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=functionsWorker-0.8327532428822592.js.map
